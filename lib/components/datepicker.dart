...
class DatePicker extends StatefulWidget {
  ...
  /// Background Gradient for the selectpr
...
class _DatePickerState extends State<DatePicker> {
  ...
  final  selectionDecoration = const BoxDecoration(
...
//            print("Inside Inactive dates.");
          ...
          return Container(
            ...
            child: DateWidget(
              date: date,
              boxDecoration: isSelected? widget.selectionDecoration : selectionDecoration,
              ...
              selectionColor:
                  isSelected ? widget.selectionColor : primaryGrey,
